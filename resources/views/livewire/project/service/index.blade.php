    ...
    <section class="application-settings-workspace mt-4 w-full max-w-[1180px] lg:mt-0">
        ...
        @else
            <aside class="application-settings-navigation min-w-0 xl:self-start">
                ...
                <a @class(['menu-item', 'menu-item-active' => request()->routeIs('project.service.index.autoscaling')])
                    {{ wireNavigate() }} href="{{ route('project.service.index.autoscaling', $parameters) }}">
                    <x-reicon name="refresh" class="menu-item-icon" />
                    <span class="menu-item-label">Autoscaling</span>
                </a>
                </nav>
            </aside>
        @endif
