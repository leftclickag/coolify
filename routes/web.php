...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}/service/{service_uuid}')->group(function () {
        ...
        Route::get('/monitor', ServiceConfiguration::class)->name('project.service.monitor');
        ...
        Route::get('/{stack_service_uuid}/autoscaling', ServiceIndex::class)->name('project.service.index.autoscaling');
